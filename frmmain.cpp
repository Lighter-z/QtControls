...
void frmMain::InitTab2()
{
    ...
    mychart1->setTitle(codec->toUnicode("图表示例"));

    myflashlist=new myFlashList(ui->fm2);
    for(int i = 0;i < 100 ; i++)
    {
        myflashlist->addItem(codec->toUnicode("列表%1").arg(i));
    }
    ...
    for(int i = 0;i < 100 ; i++)
    {
        mybuttonboard->addButton(codec->toUnicode("按钮%1").arg(i));
    }
    ...
    mysliderbutton1->addItem(codec->toUnicode("星期一"));
    mysliderbutton1->addItem(codec->toUnicode("星期二"));
    mysliderbutton1->addItem(codec->toUnicode("星期三"));
    mysliderbutton1->addItem(codec->toUnicode("星期四"));
    mysliderbutton1->addItem(codec->toUnicode("星期五"));
    mysliderbutton1->addItem(codec->toUnicode("星期六"));
    mysliderbutton1->addItem(codec->toUnicode("星期天"));
    mysliderbutton2->addItem(codec->toUnicode("星期一"));
    mysliderbutton2->addItem(codec->toUnicode("星期二"));
    mysliderbutton2->addItem(codec->toUnicode("星期三"));
    mysliderbutton2->addItem(codec->toUnicode("星期四"));
    mysliderbutton2->addItem(codec->toUnicode("星期五"));
    mysliderbutton2->addItem(codec->toUnicode("星期六"));
    mysliderbutton2->addItem(codec->toUnicode("星期天"));
    mysliderbutton3->addItem(codec->toUnicode("星期一"));
    mysliderbutton3->addItem(codec->toUnicode("星期二"));
    mysliderbutton3->addItem(codec->toUnicode("星期三"));
    mysliderbutton3->addItem(codec->toUnicode("星期四"));
    mysliderbutton3->addItem(codec->toUnicode("星期五"));
    mysliderbutton3->addItem(codec->toUnicode("星期六"));
    mysliderbutton3->addItem(codec->toUnicode("星期天"));
...
void frmMain::UpdateData1()
{
    ...
    ui->labValue1->setText(codec->toUnicode("当前值:%1").arg(value));
}
...
void frmMain::UpdateData4()
{
    ...
    ui->labValue1->setText(codec->toUnicode("当前值:%1 %2 %3").arg(value1).arg(value2).arg(value3));
}
...
void frmMain::UpdateData10()
{
    ...
    ui->labValue1->setText(codec->toUnicode("当前值:%1 %2 %3 %4 %5").arg(value1).arg(value2).arg(value3).arg(value4).arg(value5));
}
...
void frmMain::UpdateData21()
{
    ...
    ui->labValue2->setText(codec->toUnicode("当前值:%1").arg(value));
}
...
{
    ui->labValue2->setText(codec->toUnicode("当前值:%1").arg(txt));
}
...
void frmMain::UpdateData27()
{
    ...
    ui->labValue2->setText(codec->toUnicode("当前值:%1 %2 %3").arg(value1).arg(value2).arg(value3));
}
